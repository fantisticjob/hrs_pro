...
public interface IDataProcessService {
	...
	public void scheduleCalculateAllocJobForInstacneHistory(AllocScheduleInstanceBean scheduleBean,AllocRequestInstanceHistoryRecord requestHistoryBean)throws Exception;
