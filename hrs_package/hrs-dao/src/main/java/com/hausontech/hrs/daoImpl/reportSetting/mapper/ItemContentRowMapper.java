...
public class ItemContentRowMapper extends BaseRowMapper implements RowMapper<ItemContentBean> {

	@Override
	public ItemContentBean mapRow(ResultSet rs, int arg1) throws SQLException {
		ItemContentBean itemConetentBean = new ItemContentBean();
