...
public class BaseDaoImpl {
	...
	*//**
	...
	public long getAutoGeneratedPrimaryKey(String sequenceName) {
		...
		return (long)namedjdbcTemplate.getJdbcOperations().queryForObject(sql.toString(), Integer.class);
	}
	
	public int getAutoGeneratedSchedulePrimaryKey(String sequenceName) {
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT ");
		sql.append(sequenceName);
		sql.append(".Nextval FROM DUAL");
		return (int)namedjdbcTemplate.getJdbcOperations().queryForObject(sql.toString(), Integer.class);
	}
