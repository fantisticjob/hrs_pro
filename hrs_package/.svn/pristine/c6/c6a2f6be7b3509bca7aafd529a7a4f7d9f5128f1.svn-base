	...
	<script type="text/javascript"> 
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[
					{field:'sourceType',title:'类型',width:50,halign: 'center',
					...
					{field:'actualFlag',title:'余额类型',width:50,halign: 'center',
					    formatter:function(value, row, index){
					...
					{field:'currencyType',title:'币种类型',width:50,halign: 'center',
					    formatter:function(value, row, index){
					...
					{field:'currencyCode',title:'币种',width:50,halign: 'center',
						editor:{
							type:'combobox',
							options:{
							    textField:'value',
					...
					{field:'amountType',title:'金额类型',width:50,halign: 'center',
						editor:{
							type:'combobox',
							options:{
							    textField:'value',
					...
					{field:'directionCode',title:'方向',width:50,halign: 'center',
						editor:{
							type:'combobox',
							options:{
							    textField:'value',
					...
					{field:'operator',title:'符号',width:50,halign: 'center',
						editor:{
							type:'combobox',
							options:{
							    textField:'value',
					...
					{field:'constantValue',title:'常数',width:100,halign: 'center',
                      editor:{  
                          type:'validatebox'
                      }
                    },
                    {field:'description', title:'说明', width:50, halign: 'center',editor: {type:'validatebox', options:{required:false}}}, 
