	    ...
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[
					...
					{field:'FILTER_HEADER_NAME', title:'筛选条件名称',halign: 'center', width:180, editor: {type:'validatebox', options:{required:true}} }, 
					{field:'DESCRIPTION', title:'说明',halign: 'center', width:220, editor: {type:'validatebox', options:{required:false}}}, 
					{field:'DIMENSION_SEGMENT',align: 'center',title:'筛选维度',width:220,
					...
					{field:'TYPE',title:'类型',width:220,align:'center',
					formatter:function(value){
				   ...
				   {field:'area',title:'范围',width:250,align:'center',
    ...
    <script type="text/javascript">
        function doSearch(){
    	    $('#tableview').edatagrid('load',{
    		    ...
    		    deminstionName: $('#deminstionName').combobox('getValue')
    	    });
        }
    </script>
</head>
<body>
    <div id="tb" style="padding:3px">
	    ...
	    <span>维度:</span>
	    <input id="deminstionName" name="deminstionName" class="easyui-combobox"
				data-options="
		    valueField: 'DIM_SEGMENT',
		    textField: 'DIMENSION_NAME',
		    url: '/hrs/dimFilterManage/getSegmentList.do?'" />
