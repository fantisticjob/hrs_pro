	...
	<script type="text/javascript"> 
	    $(function(){
	    	$('#tableview').edatagrid({
				...
				columns:[[
                    {field:'GROUP_NUM', title:'序号', width:50, editor: {type:'validatebox', options:{required:true}} }, 
					{field:'GROUP_NAME', title:'分摊规则组', width:50, editor: {type:'validatebox', options:{required:false}}}, 
				    ...
				    {field:'area',title:'分摊规则',width:50,align:'center',
