	    ...
	    $(function(){
	    	$('#tableview').edatagrid({
				...
				columns:[[		
					...
					{field:'ITEM_TYPE', title:'外部代码类型', width:350,halign: 'center', editor: {type:'validatebox', options:{required:true}} }, 
					{field:'DESCRIPTION', title:'描述', width:350,halign: 'center', editor: {type:'validatebox', options:{required:true}}},
