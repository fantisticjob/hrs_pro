	...
	<script type="text/javascript"> 
	    ...
	    $(function(){   		    
	    	$('#tableview').edatagrid({
				...
				columns:[[
					{field:'DIM_VALUE',title:'维值',width:50,options:{required:true},
					...
					{field:'DRIVER_NAME', title:'名称', width:50, editor: {type:'validatebox', options:{required:true}}}, 	
					{field:'DESCRIPTION', title:'维值说明', width:50, editor: {type:'validatebox', options:{required:false}}}, 	
					{field:'PROPORTION', title:'比例', width:50, editor: {type:'validatebox', options:{required:true}}}, 	
					{field:'START_DATE_ACTIVE',title:'有效日期自',width:50,editor:{type:'datebox'}},
					{field:'END_DATE_ACTIVE',title:'有效日期至',width:50,editor:{type:'datebox'}},	
					{field:'STATIC_LINE_ID', title:'lineID', width:50, hidden:true}
				]],
...
<body>
    <div id="tb" style="padding:3px">
	    <span>维值:</span>
	    <input id="dimValue" name="dimValue" class="easyui-textbox" type="text" >
	    <span>名称:</span>
	    <input id="driverCode" name="driverCode" class="easyui-textbox" type="text" >
	    <a href="#" class="easyui-linkbutton" onclick="doSearch()">查询</a>
    </div>
     <form:form id="driverStaticHeaderForm" commandName="driverStaticHeader" action="" method="post">
        <form:hidden id="staticHeaderId" path="staticHeaderId" style="width:114px;"/>
