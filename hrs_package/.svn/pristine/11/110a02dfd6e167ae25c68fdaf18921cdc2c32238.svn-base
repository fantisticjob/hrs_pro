...
public class ItemRowSetLineBean extends AuditBean {
	private long rowId;
	...
	public boolean isEmpty() {
		if (!super.isEmpty() || rowId != 0 || rowSetId != 0 ||

				lineNum != 0 || !StringUtils.isBlank(rowName) || !StringUtils.isBlank(changeSign)
				|| !StringUtils.isBlank(displayFlag)) {
			return false;
		}
		return true;
	}
