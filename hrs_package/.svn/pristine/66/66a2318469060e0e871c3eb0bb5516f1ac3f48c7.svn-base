	...
	<script type="text/javascript"> 
	    ...
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[
					{field:'LINE_NUM', title:'序号', width:50, editor: {type:'validatebox', options:{required:true}}}, 
                    {field:'RULE_ID', title:'分摊规则', width:50, 
					...
					{field:'DESCRIPTION', title:'说明', width:50}, 	
					{field:'DRIVER_TYPE',title:'分摊类型',width:50},					
					{field:'START_DATE_ACTIVE',title:'有效日期自',width:50},
					{field:'END_DATE_ACTIVE',title:'有效日期至',width:50},	
