	...
	<script type="text/javascript"> 
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[ 
					{field:'DIM_VALUE', title:'维值代码', width:80,halign: 'center', editor: {type:'validatebox', options:{required:true}} }, 
					{field:'DESCRIPTION', title:'维值名称', width:100,halign: 'center', editor: {type:'validatebox', options:{required:true}}}, 
					{field:'ACCOUNT_TYPE',title:'科目属性',halign: 'center',width:80,
					...
					{field:'DIM_LEVEL',title:'维值层次',halign: 'center',width:80,
						formatter:function(value){
					...
					{field:'SUMMARY_FLAG', title:'是否汇总', width:80,align:'center',
						formatter:function(value){
							if (value == 'Y') {
								return '是';
							} else {
					...
					{field:'ATTRIBUTE1', title:'辅助段1', width:60,halign: 'center', editor:"text"}, 
					{field:'ATTRIBUTE2', title:'辅助段2', width:60,halign: 'center', editor:"text"}, 
					...
					{field:'action',title:'设置子值范围',width:80,align:'center',
