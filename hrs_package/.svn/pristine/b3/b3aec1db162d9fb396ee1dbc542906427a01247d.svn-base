...
public class RptSettingDaoImpl extends BaseDaoImpl implements IRptSettingDao {
	...
	public ItemContentBean getItemContentByByPrimaryKey(int primaryKey) throws SQLException {
		...
		try {
			...
			result = (ItemContentBean) namedjdbcTemplate.getJdbcOperations().queryForObject(sql.toString(),
	...
	private String buildCondition(AuditBean condition) {
		...
		if (condition != null) {
			...
			} else if (condition instanceof ItemContentBean) {
				ItemContentBean contentBean = (ItemContentBean) condition;
	...
	@Override
	public int countByItemContentBean(ItemContentBean reqBean) throws SQLException {
		try {
			String strCondition = buildCondition(reqBean);
			StringBuffer sql = new StringBuffer();
