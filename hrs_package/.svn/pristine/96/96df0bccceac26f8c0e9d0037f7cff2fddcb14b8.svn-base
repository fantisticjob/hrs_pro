	...
	<script type="text/javascript"> 
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[
                    {field:'lineNumber', title:'序号',align: 'center', width:50, editor: {type:'validatebox', options:{required:true}} }, 
					{field:'ruleName', title:'分摊规则名称',align: 'center', width:100, editor: {type:'validatebox', options:{required:true}}}, 
/*					{field:'driverType',title:'分摊因子配置',width:50,
					...
					{field:'startDateActive',title:'有效日期自',align: 'center',width:130,editor:{type:'datebox'}},
					{field:'endDateActive',align: 'center',title:'有效日期至',width:130,editor:{type:'datebox'}},					
					{field:'description', title:'说明', halign: 'center',width:250, editor: {type:'validatebox', options:{required:false}}}, 
					{field:'driversType',title:'分摊因子',width:100,align:'center',
						formatter:function(value,row,index) {	
							if (row.allocRuleId){
					...
					{field:'source',title:'分摊源',width:150,align:'center',
						formatter:function(value,row,index) {	
							if (row.allocRuleId){
					...
					{field:'target',title:'分摊目标',width:150,align:'center',
						formatter:function(value,row,index) {	
