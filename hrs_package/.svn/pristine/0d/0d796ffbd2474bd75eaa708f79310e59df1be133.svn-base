	    ...
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[ 
					...
					{field:'LINE_NUM', title:'序号', width:50, editor: {type:'validatebox', options:{required:true,validType:'number'}}}, 
					{field:'SIGN',title:'符号',width:50,
					...
					{field:'CONTENT_LOW', title:'账户下限', width:50 }, 
					{field:'CONTENT_HIGH', title:'账户上限', width:50 }, 
					
					{field:'actionLow',title:'账户上下限',width:50,align:'center',
