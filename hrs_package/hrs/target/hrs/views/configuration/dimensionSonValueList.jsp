	    	...
	    	$('#tableview').edatagrid({
			   ...
			   /*  onLoadSuccess: function (data) {
				...
				columns:[[ 
					...
					{field:'CHILD_DIM_VALUE_LOW', title:'子值自', width:50, editor: {type:'validatebox', options:{required:true}}}, 
					{field:'CHILD_DIM_VALUE_HIGH', title:'子值至', width:50, editor: {type:'validatebox', options:{required:true}}}, 
					...
					{field:'CREATION_DATE', title:'创建时间', width:50 }, 
					{field:'CREATED_BY', title:'创建用户', width:50 }, 
					{field:'LAST_UPDATE_DATE', title:'更新时间', width:50 }, 
					{field:'LAST_UPDATED_BY', title:'更新用户', width:50 },
