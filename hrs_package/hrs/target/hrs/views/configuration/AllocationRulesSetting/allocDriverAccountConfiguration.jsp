	...
	<script type="text/javascript">  
	    ...
	    $(function(){
	    	$('#tableview').edatagrid({
				...
				columns:[[
                    {field:'DIMENSION_SEGMENT',halign: 'center',title:'维度',width:120},	
					{field:'DIMENSION_NAME',halign: 'center', title:'维度说明', width:250}, 	
					{field:'DIMENSION_VALUE',halign: 'center',title:'维值',width:80,
					...
					{field:'FILTER_HEADER_ID',halign: 'center', title:'筛选条件', width:150,
					    formatter:function(value, row, index){
					        var returnValue = value;
					        if (value) {
					...
					{field:'DESCRIPTION',halign: 'center', title:'备注', width:250,editor: {type:'validatebox', options:{required:false}}}, 	
					{field:'DRVIER_ID',halign: 'center', title:'DRVIER_ID', width:50, hidden:true},
					{field:'DRVIER_ACC_ID',halign: 'center', title:'ACC_ID', width:50, hidden:true}
				]],
