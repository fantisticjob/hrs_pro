	...
	<script type="text/javascript"> 
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[
					{field:'DIM_SEQ', title:'序号', width:50, 
						editor:{
							type:'validatebox', 
							options:{
								required:true,
					...
					{field:'DIMENSION_CODE', title:'维度代码', width:50, editor: {type:'validatebox', options:{required:true}} }, 
					{field:'DIMENSION_NAME', title:'维度名称', width:50, editor: {type:'validatebox', options:{required:true}}}, 
					{field:'DIM_SEGMENT',title:'维度字段',width:50,
    ...
    <script type="text/javascript">
        function doSearch(){
    	    $('#tableview').edatagrid('load',{
    		    deminsionCode: $('#deminsionCode').val(),
    		    deminsionName: $('#deminstionName').val()
    	    });
        }
    </script>
</head>
