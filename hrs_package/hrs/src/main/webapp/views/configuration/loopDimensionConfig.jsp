	    ...
	    $(function(){
			...
			scrolling: true,
				...
				columns:[[ 
					...
					{field:'RULE_LINE_SEQ', title:'序号',halign: 'center', width:250, 
						editor:{
							type:'validatebox', 
							options:{
								required:true,
					...
					{field:'DIM_SEGMENT',title:'维度',halign: 'center',width:350,
						editor:{
							type:'combobox',
							options:{
					...
					{field:'DESCRIPTION', title:'维度名称',halign: 'center', width:500}
				]],
