	    ...
	    $(function() {
			...
			scrolling: true,
				...
				columns:[[		
					...
					{field:'RULE_CODE',title:'循环组',halign: 'center',width:270,
					...
					{field:'ITEM_CODE', title:'表项代码',halign: 'center', width:270, editor: {type:'validatebox', options:{required:true}} }, 
					{field:'DESCRIPTION', title:'表项名称',halign: 'center', width:270, editor: {type:'validatebox', options:{required:true}} }, 
