	    ...
	    $(function(){	   
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[ 
					...
					{field:'ROW_CAL_NUM', title:'序号', width:360 ,halign: 'center',editor: {type:'validatebox', options:{required:true}}}, 
					{field:'SIGN',title:'运算符',width:360,halign: 'center',
					...
					{field:'CAL_ITEM_CODE', title:'计算行项目',width:360,halign: 'center',
