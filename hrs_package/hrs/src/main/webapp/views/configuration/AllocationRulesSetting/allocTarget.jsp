	...
	<script type="text/javascript"> 
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[
					{field:'targetType',title:'类型',halign: 'center',width:50,
					...
					{field:'currencyType',halign: 'center',title:'币种类型',width:50,
					    formatter:function(value, row, index){
					...
					{field:'currencyCode',halign: 'center',title:'币种',width:50,
						editor:{
							type:'combobox',
							options:{
							    textField:'value',
					...
					{field:'amountType',halign: 'center',title:'金额类型',width:50,
						editor:{
							type:'combobox',
							options:{
							    textField:'value',
					...
					{field:'directionCode',halign: 'center',title:'方向',width:50,
						editor:{
							type:'combobox',
							options:{
							    textField:'value',
                    ...
                    {field:'description',halign: 'center', title:'说明', width:50, editor: {type:'validatebox', options:{required:false}}}, 
