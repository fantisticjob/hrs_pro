           ...
           // var flag  ;   //判断新增和修改方法 
	    	$('#tableview').edatagrid({
				...
				columns:[[
				    ...
				    {field:'RULE_TYPE',title:'规则类型',align: 'center',width:50,
					...
					{field:'RULE_ID', title:'规则',align: 'center',width:50,
						formatter:function(value, row, index){
					...
					{field:'PERIOD',title:'会计区间',align: 'center',width:50,
						formatter:function(value, row, index){
					...
					{field:'DESCRIPTION',title:'说明',halign: 'center',align:'left',width:80,editor: {type: "validatebox",options:{required:true}}},
