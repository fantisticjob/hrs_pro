...
<head>
	...
	<script type="text/javascript">  
		//get title		 		    
		var tabTile ="<%=session.getAttribute("ruleName").toString()%>"+'来源账户设置';
		var sourceId=<%=session.getAttribute("sourceId")%>;
		var dataUrl = '/hrs/dimFilterManage/findAllocSourceAccount.do?sourceId=' + sourceId;  
	    $(function(){
	    	$('#tableview').edatagrid({
				title:tabTile,
				nowrap: false,
				...
				columns:[[
                    {field:'DIMENSION_SEGMENT',title:'维度',halign: 'center',width:50},	
					...
					{field:'FILTER_HEADER_ID',halign: 'center', title:'筛选条件', width:50,
					    formatter:function(value, row, index){
					        var returnValue = value;
					        if (value) {
					...
					{field:'SOURCE_ID',halign: 'center', title:'SOURCE_ID', width:50, hidden:true},
					{field:'SOURCE_ACC_ID', title:'ACC_ID', width:50, hidden:true}
				]],
				...
				updateUrl: '/hrs/dimFilterManage/updateAllocSourceAccount.do?sourceId=' + sourceId
	    	});
	    });
...
<body>
  <!--    <div id="tb" style="padding:3px">
     ...
     <form:form id="allocSource" commandName="allocSource" action="" method="post">
        <form:hidden id="sourceId" path="sourceId" style="width:114px;"/>
