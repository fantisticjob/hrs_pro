	...
	<script type="text/javascript"> 
	    $(function(){
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[ 
					{field:'ITEM_VALUE_ID', title:'外部代码行ID',halign: 'center', width:50, hidden: true},
					{field:'ITEM_TYPE_ID', title:'外部代码头ID', width:50, hidden: true},
					{field:'ITEM_VALUE', title:'外部代码行值',halign: 'center', width:125, editor: {type:'validatebox', options:{required:true}} }, 
					{field:'DESCRIPTION', title:'描述',halign: 'center', width:125, editor: {type:'validatebox', options:{required:true}}}, 
					{field:'START_DATE', title:'有效日期自',halign: 'center', width:125 }, 
					{field:'END_DATE', title:'有效日期至',halign: 'center', width:125}, 
					{field:'ATTRIBUTE1', title:'辅助段1',halign: 'center', width:120, editor: {type:'validatebox', options:{required:false}}}, 
					{field:'ATTRIBUTE2', title:'辅助段2',halign: 'center', width:120, editor: {type:'validatebox', options:{required:false}}}, 
					{field:'ATTRIBUTE3', title:'辅助段3',halign: 'center', width:120, editor: {type:'validatebox', options:{required:false}}}, 
					{field:'ATTRIBUTE4', title:'辅助段4',halign: 'center', width:120, editor: {type:'validatebox', options:{required:false}}}, 
					{field:'ATTRIBUTE5', title:'辅助段5',halign: 'center', width:120, editor: {type:'validatebox', options:{required:false}}}					
				]],
