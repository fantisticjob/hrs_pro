	     ...
	     /*   var ledgerList='{}';
		   ...
		   $.ajax({    
	    	...
	    	$('#tableview').edatagrid({
				...
				columns:[[
				    {field:'seqNumber',title:'行号',width:30,halign: 'center',  /*width:50,*/
                      editor:{                       
                          type:'numberbox',
                          options:{
						      required:true
                    ...
                    {field:'ledgerId', title:'账套',halign: 'center',width:40,
					/*	editor:{
							type:'combogrid',
							options:{
				                panelWidth:500,
				                ...
				                autoSizeColumn:true,
				                columns:[[
					                {field:'LOOKUP_VALUE',title:'编码',halign: 'center',width:40},
				   ...
				   /* {field:'ledgerId', title:'账套',width:60,  //width:80,
					...
					{field:'finElement',title:'财务要素',halign: 'center',width:50,
						editor:{
							type:'combogrid',
							options:{
				                panelWidth:500,
				                ...
				                columns:[[
					                {field:'LOOKUP_VALUE',title:'编码',halign: 'center',width:40},
					                {field:'DESCRIPTION',title:'说明',halign: 'center',align:'left',width:80}
			                   	]],
			                   	options:{
							        required:true
							    },
					...
					{field:'segment1',title:'公司',halign: 'center',width:80,  /*width:120,*/
					  /*  formatter:function(value){
						...
						editor:{
							...
							options:{
				                ...
				                autoSizeColumn:true,
				                columns:[[
					                {field:'DIM_VALUE',title:'维度值',halign: 'center',width:40},
					                {field:'DESCRIPTION',title:'说明',halign: 'center',/*align:'right',*/width:80}
			                   	]],
					...
					{field:'segment2',title:'部门',halign: 'center',width:80,  /*width:120,*/
					 /*  formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
					...
					{field:'segment3',title:'会计科目',width:100,halign: 'center',  /*width:120,*/
				/*	    formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
						...
						editor:{
							...
							options:{
				                ...
				                autoSizeColumn:true,
				                columns:[[
					                {field:'DIM_VALUE',halign: 'center',title:'维度值',width:40},
					                {field:'DESCRIPTION',halign: 'center',title:'说明',/*align:'right',*/width:80}
			                   	]],
					...
					{field:'segment4',title:'辅助科目',halign: 'center',width:80,  /*width:120,*/
					  /*  formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
					...
					{field:'segment5',title:'来源',halign: 'center',width:50,  /*width:120,*/
					/*    formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
					...
					{field:'segment6',title:'项目',halign: 'center',width:80,  /*width:120,*/
					   /* formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
					...
					{field:'segment7',title:'往来',halign: 'center',width:80,  /*width:120,*/
					/*    formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
					...
					{field:'segment8',title:'产品',halign: 'center',width:100,  /*width:120,*/
					 /*   formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
					...
					{field:'segment9',title:'备用1',halign: 'center',width:45,  /*width:120,*/
					/*    formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
					...
					{field:'segment10',title:'备用2',halign: 'center',width:45,  /*width:120,*/
				/*	    formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
					...
					{field:'segment11',title:'备用3',halign: 'center',width:45,  /*width:120,*/
					  /*  formatter:function(value){
					        var returnValue = value;
					        if (value) {
					            var postData = "selDimValueCode=" + value;							
                    ...
                    {field:'amountDR',title:'借方金额',halign: 'center',width:100,align:'right',
                    	formatter:function(value){
                ...
                /*      formatter: function(value){
				    ...
				    {field:'amountCR',title:'贷方金额',halign: 'center',width:100,align:'right',
				       formatter:function(value){
                          return (value || 0).toString().replace(/(\d)(?=(?:\d{3})+$)/g, '$1,');
					  },
                      editor:{  
					...
					{field:'description', title:'事务说明',halign: 'center', width:450,  /*width:120,*/ editor:'text'},
					{field:'info',title:'信息',halign: 'center',width:450 }, 		
					{field:'creationDate',halign: 'center', title:'创建时间', width:30,  /*width:50,*/  hidden:true},
					{field:'createdBy',halign: 'center', title:'创建人', width:30,  /*width:50,*/ hidden:true},
					{field:'lastUpdateDate',halign: 'center', title:'最后更新时间', width:30,  /*width:50,*/ hidden:true},
					{field:'lastUpdatedBy',halign: 'center', title:'最后更新人', width:30,  /*width:50,*/ hidden:true},
					{field:'txnHeaderId', halign: 'center',title:'事务处理头ID', width:30,  /*width:50,*/ hidden:true},
					{field:'txnLineId',halign: 'center', title:'事务处理头ID', width:30,  /*width:50,*/ hidden:true}
				]],
